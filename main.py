...
#8888888888888888888888888888888888888   transcribe and translate and display 88888888888888888888888888888888888888888888888888888

def whatsaid(queue):
	global silence,mytext,tag,fromLanguage,toLanguage
	while True:
		if (queue.qsize()!=0):
			frames = queue.get()
